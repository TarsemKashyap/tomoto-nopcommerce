...
namespace Nop.Services.Vendors
{
    ...
    public partial class VendorService : IVendorService
    {
        ...
        private readonly IRepository<GeoLocation> _vendorLocationRepository;
        ...
        public VendorService(IHtmlFormatter htmlFormatter,
            ...
            IRepository<GeoLocation> vendorLocationRepository)
        {
        ...
        public virtual async Task InsertGeoLocationAsync(GeoLocation geoLocation)
        {
            await _vendorLocationRepository.InsertAsync(geoLocation);
        }

        public virtual async Task RemoveLocation(GeoLocation geoLocation)
        {
            await _vendorLocationRepository.DeleteAsync(geoLocation);
        }
        public virtual async Task<GeoLocation> GetLocationById(int id)
        {
          var obj =   await _vendorLocationRepository.GetByIdAsync(id);
            return obj;
        }
