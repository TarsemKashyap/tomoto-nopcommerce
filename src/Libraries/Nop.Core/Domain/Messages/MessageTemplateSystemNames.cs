namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of notification Delivery Man about  about placed order
        /// </summary>
        public const string OrderPlacedDeliveryManNotification = "OrderPlaced.DeliveryManNotification";
