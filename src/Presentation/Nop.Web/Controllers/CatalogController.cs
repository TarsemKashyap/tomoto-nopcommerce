...
namespace Nop.Web.Controllers
{
    ...
    public partial class CatalogController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> CategoryPage(List<LatLangModel> newDataLatLng,  int categoryId, CatalogProductsCommand command)
        {
            ...
            //model
            var model = await _catalogModelFactory.PrepareCategoryModelAsync(category, command,newDataLatLng);
        ...
        {
            List<LatLangModel> dataLatLng = HttpContext.Session.GetComplexData<List<LatLangModel>>("latlngModel");
            ...
            //model
            var model = await _catalogModelFactory.PrepareCategoryModelAsync(category, command, dataLatLng);
        ...
        public virtual async Task<IActionResult> GetCategoryProducts(int categoryId, CatalogProductsCommand command)
        {
            ...
            var model = await _catalogModelFactory.PrepareCategoryProductsModelAsync(category, command, dataLatLng);
