...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        #endregion
        public async Task<bool> IsDeliveryManAsync(Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.DeliveryManRoleName, onlyActiveCustomerRoles);
        }
        public async Task<IList<Customer>> GetCustomerbyCustomerRole(int customerRoleId)
        {
            var query = _customerRepository.Table;
            query = query.Where(c => !c.Deleted);
            query = query.Where(c => _customerCustomerRoleMappingRepository.Table.Any(ccrm => ccrm.CustomerId == c.Id && customerRoleId == (ccrm.CustomerRoleId)));
            query = query.OrderByDescending(c => c.LastActivityDateUtc);
