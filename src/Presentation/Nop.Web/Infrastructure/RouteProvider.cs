...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //GeoLOcation Check
            endpointRouteBuilder.MapControllerRoute(name: "CheckService",
                pattern: $"product/checkservice",
                defaults: new { controller = "Product", action = "CheckService" });
            ...
            //bhanu chauhan 20/05/2022
            endpointRouteBuilder.MapControllerRoute(name: "CheckVendorForProduct",
                pattern: $"{lang}/shoppingcart/checkforvendor/{{productId:min(0)}}/{{shoppingCartTypeId:min(0)}}",
                defaults: new { controller = "ShoppingCart", action = "CheckForVendor" });
            //bhanu chauhan  20/05/2022
