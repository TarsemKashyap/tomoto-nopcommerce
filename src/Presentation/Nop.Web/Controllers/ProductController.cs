...
namespace Nop.Web.Controllers
{
    ...
    public partial class ProductController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> GeoLocation()
        {
            return View();
        }
        ...
        public virtual async Task<IActionResult> CheckService(int vendorId)
        {


            var geoLocations = await _productService.CheckGeoLocationService(vendorId);

            var options = new JsonSerializerOptions()
            {
                PropertyNamingPolicy = JsonNamingPolicy.CamelCase
            };
            string json = System.Text.Json.JsonSerializer.Serialize(geoLocations,options);
            return Ok(json);
          
            //return Json(JsonConvert.SerializeObject(geoLocations, Formatting.Indented)); 
        ...
        [HttpGet]
        public virtual async Task<IActionResult> CheckServices(int vendorId)
        {
