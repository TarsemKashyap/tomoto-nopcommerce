...
namespace Nop.Web.Factories
{
    public partial interface ICatalogModelFactory
    {
        ...
        /// </returns>
        Task<CategoryModel> PrepareCategoryModelAsync(Category category, CatalogProductsCommand command,List<LatLangModel> latLangModel = null);
        ...
        /// </returns>
        Task<CatalogProductsModel> PrepareCategoryProductsModelAsync(Category category, CatalogProductsCommand command, List<LatLangModel> latLangModel = null);
