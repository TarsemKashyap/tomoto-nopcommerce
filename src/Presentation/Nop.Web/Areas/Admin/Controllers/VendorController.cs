...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class VendorController : BaseAdminController
    {
        ...
        [HttpPost]
        public virtual async Task<IActionResult> AddGeoLocation(int vendorId, List<GeoLocationModel> latLngArray)
        {
        ...
        public virtual async Task<IActionResult> Edit(int id)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageVendors))
                return AccessDeniedView();
            HttpContext.Session.SetInt32("VendorId", id);
        ...
        [HttpPost]
        public virtual async Task<IActionResult> RemoveLocation(int id)
        {
