...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        protected readonly IRepository<GeoLocation> _locationRepository;
        ...
        public ProductService(CatalogSettings catalogSettings,
            ...
            IRepository<GeoLocation> locationRepository
            )
        {
        ...
        /// </returns>
        public virtual async Task<IList<Product>> GetAllProductsDisplayedOnHomepageAsync(List<int> vendorIds = null)
        {
            ...
            return await _productRepository.GetAllAsync(query =>
            {
                ...
                query = products.Where(pc => (vendorIds.Contains(pc.VendorId)) ||(pc.Published == true && pc.ShowOnHomepage));
                return query;
            ...
            //           //where (vendorIds.Contains(p.VendorId)) && p.Published &&
            //           //      !p.Deleted &&
            //           //      p.ShowOnHomepage
        ...
        public virtual async Task<IPagedList<Product>> SearchProductsAsync(
            ...
            bool? overridePublished = null, List<int> vendorIds = null)
        {
        ...
        public async Task<IList<GeoLocation>> CheckGeoLocationService(int? vendorId)
        {
            ...
            //return await _locationRepository.GetAllAsync(query =>
            //{

            //    var locationCheck = _locationRepository.Table;



            //    query = locationCheck.Where(pc => (pc.Latitude >= lat && pc.Longitude >= lng) && ( pc.CityName == cityName || cityName == null));
